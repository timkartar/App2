...
public class OtherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Databasehelper myDbHelper = new Databasehelper(OtherActivity.this);
        ...
        final Cursor cursor = myDbHelper.query("birds", null, null, null, null, null, null);
        cursor.moveToFirst();
        change(cursor);
    ...
    public void change(Cursor cursor){
        ...
        TextView scname= (TextView) findViewById(R.id.textView12);
        scname.setText("SCIENTIFIC NAME: " + cursor.getString(2) + "\n");
        TextView des= (TextView) findViewById(R.id.textView13);
    ...
    private  android.os.Handler chuckFinishedHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(OtherActivity.this, "Wallpaper set", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(OtherActivity.this, "Uh oh, can't do that right now", Toast.LENGTH_SHORT).show();
                    break;
                default:
