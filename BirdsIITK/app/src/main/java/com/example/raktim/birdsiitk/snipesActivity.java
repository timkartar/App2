...
public class snipesActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_snipes);
        ...
        Databasehelper myDbHelper = new Databasehelper(snipesActivity.this);
        ...
        final Cursor cursor = myDbHelper.query("snipes", null, null, null, null, null, null);
        cursor.moveToFirst();
        change(cursor);
        ...
        ((Button) findViewById(R.id.button09)).setOnClickListener(new View.OnClickListener(){
        ...
        final ImageView imageView = (ImageView) findViewById(R.id.imageView26);
    ...
    public void change(Cursor cursor){
        ...
        TextView scname= (TextView) findViewById(R.id.textView28);
        scname.setText("SCIENTIFIC NAME: " + cursor.getString(2) + "\n");
        TextView des= (TextView) findViewById(R.id.textView29);
    ...
    private  android.os.Handler chuckFinishedHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(snipesActivity.this, "Wallpaper set", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(snipesActivity.this, "Uh oh, can't do that right now", Toast.LENGTH_SHORT).show();
                    break;
                default:
