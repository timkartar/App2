...
public class martinsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_martins);
        ...
        Databasehelper myDbHelper = new Databasehelper(martinsActivity.this);
        ...
        final Cursor cursor = myDbHelper.query("martins", null, null, null, null, null, null);
        cursor.moveToFirst();
        change(cursor);
        ((Button) findViewById(R.id.button020)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.button021)).setOnClickListener(new View.OnClickListener(){
        ...
        final ImageView imageView = (ImageView) findViewById(R.id.imageView50);
    ...
    public void change(Cursor cursor){
        ...
        TextView name= (TextView) findViewById(R.id.textView51);
        name.setText("NAME: " + cursor.getString(1) + "\n");
        TextView scname= (TextView) findViewById(R.id.textView52);
        scname.setText("SCIENTIFIC NAME: " + cursor.getString(2) + "\n");
        TextView des= (TextView) findViewById(R.id.textView53);
    ...
    private  android.os.Handler chuckFinishedHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(martinsActivity.this, "Wallpaper set", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(martinsActivity.this, "Uh oh, can't do that right now", Toast.LENGTH_SHORT).show();
                    break;
                default:
