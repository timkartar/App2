...
public class ducksActivity extends AppCompatActivity {
    ...
    Databasehelper myDbHelper = new Databasehelper(ducksActivity.this);
    ...
    final Cursor cursor = myDbHelper.query("ducks", null, null, null, null, null, null);
    cursor.moveToFirst();
    change(cursor);
    ...
    public void change(Cursor cursor){
        ...
        TextView scname= (TextView) findViewById(R.id.textView20);
        scname.setText("SCIENTIFIC NAME: " + cursor.getString(2) + "\n");
        TextView des= (TextView) findViewById(R.id.textView21);
...
private  android.os.Handler chuckFinishedHandler = new android.os.Handler() {
    ...
    public void handleMessage(Message msg) {
        switch (msg.what) {
            case 0:
                Toast.makeText(ducksActivity.this, "Wallpaper set", Toast.LENGTH_SHORT).show();
                break;
            case 1:
                Toast.makeText(ducksActivity.this, "Uh oh, can't do that right now", Toast.LENGTH_SHORT).show();
                break;
            default:
