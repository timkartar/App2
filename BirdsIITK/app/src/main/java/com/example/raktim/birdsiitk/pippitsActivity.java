...
public class pippitsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pippits);
        ...
        Databasehelper myDbHelper = new Databasehelper(pippitsActivity.this);
        ...
        final Cursor cursor = myDbHelper.query("pippits", null, null, null, null, null, null);
        cursor.moveToFirst();
        change(cursor);
        ((Button) findViewById(R.id.button016)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.button017)).setOnClickListener(new View.OnClickListener(){
        ...
        final ImageView imageView = (ImageView) findViewById(R.id.imageView42);
    ...
    public void change(Cursor cursor){
        ...
        TextView scname= (TextView) findViewById(R.id.textView44);
        scname.setText("SCIENTIFIC NAME: " + cursor.getString(2) + "\n");
        TextView des= (TextView) findViewById(R.id.textView45);
    ...
    private  android.os.Handler chuckFinishedHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(pippitsActivity.this, "Wallpaper set", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(pippitsActivity.this, "Uh oh, can't do that right now", Toast.LENGTH_SHORT).show();
                    break;
                default:
