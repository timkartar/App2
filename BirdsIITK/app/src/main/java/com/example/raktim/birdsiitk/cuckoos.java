...
public class cuckoos extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cuckoos);
        ...
        Databasehelper myDbHelper = new Databasehelper(cuckoos.this);
        ...
        final Cursor cursor = myDbHelper.query("cuckoos", null, null, null, null, null, null);
        cursor.moveToFirst();
        change(cursor);
        ((Button) findViewById(R.id.button026)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.button027)).setOnClickListener(new View.OnClickListener(){
        ...
        final ImageView imageView = (ImageView) findViewById(R.id.imageView62);
    ...
    public void change(Cursor cursor){
        ...
        TextView name= (TextView) findViewById(R.id.textView63);
        name.setText("NAME: " + cursor.getString(1) + "\n");
        TextView scname= (TextView) findViewById(R.id.textView64);
        scname.setText("SCIENTIFIC NAME: " + cursor.getString(2) + "\n");
        TextView des= (TextView) findViewById(R.id.textView65);
    ...
    private  android.os.Handler chuckFinishedHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(cuckoos.this, "Wallpaper set", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(cuckoos.this, "Uh oh, can't do that right now", Toast.LENGTH_SHORT).show();
                    break;
                default:
