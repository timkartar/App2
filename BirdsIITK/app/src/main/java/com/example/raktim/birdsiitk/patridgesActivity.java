...
public class patridgesActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_patridges);
        ...
        Databasehelper myDbHelper = new Databasehelper(patridgesActivity.this);
        ...
        final Cursor cursor = myDbHelper.query("patridges", null, null, null, null, null, null);
        cursor.moveToFirst();
        change(cursor);
        ((Button) findViewById(R.id.button022)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.button023)).setOnClickListener(new View.OnClickListener(){
        ...
        final ImageView imageView = (ImageView) findViewById(R.id.imageView54);
    ...
    public void change(Cursor cursor){
        ...
        TextView name= (TextView) findViewById(R.id.textView55);
        name.setText("NAME: " + cursor.getString(1) + "\n");
        TextView scname= (TextView) findViewById(R.id.textView56);
        scname.setText("SCIENTIFIC NAME: " + cursor.getString(2) + "\n");
        TextView des= (TextView) findViewById(R.id.textView57);
    ...
    private  android.os.Handler chuckFinishedHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(patridgesActivity.this, "Wallpaper set", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(patridgesActivity.this, "Uh oh, can't do that right now", Toast.LENGTH_SHORT).show();
                    break;
                default:
