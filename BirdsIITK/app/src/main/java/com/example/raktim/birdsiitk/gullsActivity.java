...
public class gullsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Databasehelper myDbHelper = new Databasehelper(gullsActivity.this);
        ...
        final Cursor cursor = myDbHelper.query("gulls", null, null, null, null, null, null);
        cursor.moveToFirst();
        change(cursor);
        ((Button) findViewById(R.id.button018)).setOnClickListener(new View.OnClickListener() {
        ...
        ((Button) findViewById(R.id.button019)).setOnClickListener(new View.OnClickListener(){
        ...
        final ImageView imageView = (ImageView) findViewById(R.id.imageView46);
    ...
    public void change(Cursor cursor){
        ...
        TextView name= (TextView) findViewById(R.id.textView47);
        name.setText("NAME: " + cursor.getString(1) + "\n");
        TextView scname= (TextView) findViewById(R.id.textView48);
        scname.setText("SCIENTIFIC NAME: " + cursor.getString(2) + "\n");
        TextView des= (TextView) findViewById(R.id.textView49);
    ...
    private  android.os.Handler chuckFinishedHandler = new android.os.Handler() {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    Toast.makeText(gullsActivity.this, "Wallpaper set", Toast.LENGTH_SHORT).show();
                    break;
                case 1:
                    Toast.makeText(gullsActivity.this, "Uh oh, can't do that right now", Toast.LENGTH_SHORT).show();
                    break;
                default:
